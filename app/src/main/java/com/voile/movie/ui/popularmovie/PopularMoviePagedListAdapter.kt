package com.voile.movie.ui.popularmovie
...
import com.voile.movie.R
import com.voile.movie.data.api.POSTER_BASE_URL
import com.voile.movie.data.repository.NetworkState
import com.voile.movie.data.vo.Movie
import com.voile.movie.ui.singlemovie.SingleMovie
...
class PopularMoviePagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class NetworkStateItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(networkState: NetworkState?) {
            ...
            else if (networkState != null && networkState == NetworkState.EOF) {
                itemView.error_msg_item.visibility = View.VISIBLE;
                itemView.error_msg_item.text = networkState.msg;
            }
            else {
